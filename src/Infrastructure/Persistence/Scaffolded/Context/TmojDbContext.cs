...
public partial class TmojDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ClassSemester>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ClassId, e.SemesterId }, "uq_class_semester").IsUnique();
        ...
        modelBuilder.Entity<Problem>(entity =>
        {
            ...
            entity.Property(e => e.ScoringCode).HasColumnName("scoring_code");
            entity.Property(e => e.Slug).HasColumnName("slug");
            entity.Property(e => e.StatementContentType)
                .HasMaxLength(100)
                .HasColumnName("statement_content_type");
            entity.Property(e => e.StatementExtension)
                .HasMaxLength(20)
                .HasColumnName("statement_extension");
            entity.Property(e => e.StatementFileId).HasColumnName("statement_file_id");
            entity.Property(e => e.StatementFileName)
                .HasMaxLength(255)
                .HasColumnName("statement_file_name");
            entity.Property(e => e.StatementSourceCode)
                .HasMaxLength(20)
                .HasColumnName("statement_source_code");
            entity.Property(e => e.StatementUploadedAt).HasColumnName("statement_uploaded_at");
