...
public class GetClassSlotRankingsQueryHandler
    : IRequestHandler<GetClassSlotRankingsQuery, ClassSlotRankingDto>
{
    ...
    public async Task<ClassSlotRankingDto> Handle(
        ...
        CancellationToken ct)
    {
        ...
        return new ClassSlotRankingDto(
            request.ClassSlotId,
            classSlot.Title,
            classSlot.Description,
            classSlot.DueAt,
            rankings,
            DateTime.UtcNow
        );
