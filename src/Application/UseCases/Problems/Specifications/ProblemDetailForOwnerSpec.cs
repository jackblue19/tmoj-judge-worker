...
//public sealed class ProblemDetailForOwnerSpec : Specification<Problem , ProblemDetailDto>
//{
//    public ProblemDetailForOwnerSpec(Guid problemId)
//    {
//        Query.Where(x => x.Id == problemId)
//             .Select(x => new ProblemDetailDto
//             {
//                 Id = x.Id ,
//                 Title = x.Title ,
//                 Slug = x.Slug ,
