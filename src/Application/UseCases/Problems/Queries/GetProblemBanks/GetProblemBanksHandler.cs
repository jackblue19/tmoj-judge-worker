...
public sealed class GetProblemBanksHandler
    : IRequestHandler<GetProblemBanksQuery , ApiPagedResponse<ProblemBankListItemDto>>
{
        ...
        CancellationToken ct)
    {
        ...
        var countSpec = new ProblemBanksCountSpec(
            normalizedSearch ,
            normalizedDifficulty);

        var listSpec = new ProblemBanksPagedSpec(
            safePage ,
            safePageSize ,
            normalizedSearch ,
            normalizedDifficulty);
        ...
        return ApiPagedResponse<ProblemBankListItemDto>.Ok(
            ...
            message: "Fetched problem banks successfully." ,
